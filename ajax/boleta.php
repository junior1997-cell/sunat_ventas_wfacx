...
switch ($_GET["op"]) {
    ...
    ',
                //<a class="dropdown-item" href="#"><i  class="fa fa-level-down"   onclick="baja('.$reg->idboleta.')" data-toggle="tooltip" title="Anular y dar de baja"  style="display:'.$stt.';  color:red; font-size:12px;" ></i> Dar de baja</a>
                //<a style="font-family: Georgia, serif;" class="dropdown-item" onclick="prea42copias2('.$reg->idboleta.')">
                //<i class="fa fa-print"  data-toggle="tooltip" title="Imprimir formato 2 copias" > Imprimir formato 2 copias</i></a>
                //<a class="dropdown-item" href="#" ><i class="fa fa-send"  data-toggle="tooltip" title="Enviar por correo a: '.$reg->email.'"  onclick="enviarcorreo('.$reg->idboleta.')"   style="display:'.$send.'; color:blue; font-size:11px;" >
                //</i></a> 
                ...
                //<a><i class="fa fa-download" style="color:#2acc70; font-size:18px;"  data-toggle="tooltip" title="Descargar JSON" onclick="downFtp('.$reg->idboleta.')"  ></i></a>
                //Opciones de envio
                // <a onclick="generarxml('.$reg->idboleta.')" '.$sunatFirma.'="class_a_href"><i class="fa fa-download"  style="color:orange; font-size:18px;" data-toggle="tooltip" title="Generar xml"   ></i></a>
                //<a href="https://bit.ly/31qZoI1" target=_blank >  <img src="../public/images/sunat.png" style="color:green; font-size:18px;"  data-toggle="tooltip" title="Consulta de validez con SUNAT"   ></i></a>
                "9" =>
                '       
