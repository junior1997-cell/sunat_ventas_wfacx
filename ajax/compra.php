        ...
        while ($reg=$rspta->fetch_object()){
            ...
            $data[]=array(
                ...
                <ul class="dropdown-menu pull-center">
                    <li>
                   <a target="_blank" href="../reportes/compraReporte.php?idcompra='.$reg->idcompra.'" data-toggle="tooltip" title="Vista impresión"> <i class="fa  fa-eye"> Imprimir </i>
                     </a>

                  </li>

                  <li>
                   <a onclick="eliminarcompra('.$reg->idcompra.')" data-toggle="tooltip" title="Anular compra"> <i class="fa fa-close"> Anular </i>
                   </a>
