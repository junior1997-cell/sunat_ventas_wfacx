        ...
        if (empty($idnotaped)) {
            ...
            if ($idcliente == "N") {
                ...
                $rspta = $notapedido->insertar(
                    ...
                    $tipo_moneda_24,
                    $tasa_igv, $_POST["idarticulo"], $_POST["numero_orden_item_29"], $_POST["cantidad_item_12"], $_POST["codigo_precio_14_1"], $_POST["precio_unitario"], $_POST["igvBD"], $_POST["igvBD"], $_POST["afectacion_igv_3"], $_POST["afectacion_igv_4"], $_POST["afectacion_igv_5"], $_POST["afectacion_igv_6"], $_POST["igvBD2"], $_POST["vvu"], $_POST["subtotalBD"], $_POST["codigo"], $_POST["unidad_medida"],
                    $idserie,
                    $SerieReal,
                    $numero_boleta,
                    $tipo_doc_ide,
