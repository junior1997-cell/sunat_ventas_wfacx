                            ...
                            <div class="container-fluid dashboard">
                                <form name="formulario" id="formulario" method="POST">
                                    <div class="content-header">
                                        <h1>Compras <button type="button" class="btn btn-success btn-sm" onclick="redirectToPage()">Ver lista de
                                                compra</> | <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#myModal">Agregar Producto</button></h1>
                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table id="detalles" class="table table-striped">
                                                            <thead style="background-color:##081A51">
                                                            ...
                                                            <tfoot style=" top: 30px; position: relative; font-size: 1em;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th
                                                                        style="font-weight: bold; vertical-align: center; background-color:#081A51; color:white;">
                                                                        SUBTOTAL</th>

                                                                    <th style="font-weight: bold; background-color:#081A51; color:white;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th
                                                                        style="font-weight: bold; background-color:#081A51; vertical-align: center;color:white;">

                                                                        <h4 id="igv_"
                                                                            style="vertical-align: right; font-weight: bold; background-color:#081A51;color:white;">
                                                                            0.00</h4>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th
                                                                        style="font-weight: bold; vertical-align: center; background-color:#081A51;color:white;">
                                                                        TOTAL</th> <!--Datos de impuestos--> <!--IGV-->
                                                                    <th style="font-weight: bold; background-color:#081A51;color:white;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="serie_comprobante"
                                                                id="serie_comprobante" required="true" onkeyup="mayus(this);"
                                                                onkeypress="EnterSerie(event)">
                                                        </div>
                                                        <div class="mb-3 col-lg-6">
                                                        ...
                                                        <div class="mb-3 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="vunitario" id="vunitario" value=""
                                                                placeholder="Valor unitario para todos los articulos"
                                                                style="background-color: #DAF7A6;" onkeypress="return EnterVuni(event,this)"
                                                                onblur="modificarSubototales()" onkeyup="modificarSubototales();">
                                                        ...
                                                        <div class="mb-3 col-lg-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text" data-bs-toggle="modal"
                                                                    data-bs-target="#ModalNcategoria" style="cursor:pointer;"
                                                                    id="basic-addon1">+</span>
                                                                <select id="idproveedor" name="idproveedor" class="form-control"
                                                                    data-live-search="true" required onchange="cambioproveedor()"></select>
