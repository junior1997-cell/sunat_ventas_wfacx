...
if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['almacen'] == 1) {
        ?>
                            ...
                            <div class="container-fluid dashboard">
                                <div class="content-header">
                                    <h1>Productos <button class="btn btn-primary btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal"
                                            ...
                                            id="refrescartabla" onclick="refrescartabla()">Refrescar tabla</button></h1>
                                </div>
                        ...
                        <div class="modal fade text-left" id="modalAgregarProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
                            aria-hidden="true">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" name="codigo" id="codigo"
                                                        placeholder="Código Barras" required="true" onkeyup="mayus(this);"
                                                        onblur="generarbarcode()" onchange="validarcodigo()">
