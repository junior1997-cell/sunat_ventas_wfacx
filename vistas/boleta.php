                        ...
                        <div class="content-start transition">
                            ...
                            <section class="container-fluid dashboard">
                                <div class="content-header">
                                    <h1>Boleta electrónica <button class="btn bg-primary btn-sm" id="btnagregar"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 col-lg-6">
                                                                        <label for="recipient-name" class="col-form-label">Tipo de
                                                                            boleta:</label>
                                                                        <select class="form-control" name="tipoboleta" id="tipoboleta"
                                                                    ...
                                                                    <input type="hidden" name="firma_digital_36" id="firma_digital_36"
                                                                        value="44477344">
                                                                    ...
                                                                    <input type="hidden" name="tipo_documento_06" id="tipo_documento_06"
                                                                        value="03">
                                                                    ...
                                                                    <input type="hidden" name="tipo_documento_cliente"
                                                                        id="tipo_documento_cliente" value="0">
                                                                    <!--Datos del cliente-->

                                                                    <!--Datos de impuestos-->
                                                                    <input type="hidden" name="codigo_tipo_15_1" id="codigo_tipo_15_1"
                                                                        value="1001">
                                                                    ...
                                                                    <input type="hidden" name="tipo_documento_25_1" id="tipo_documento_25_1"
                                                                        value="">
                                                                    <input type="hidden" name="codigo_leyenda_26_1" id="codigo_leyenda_26_1"
                                                                        value="1000">
                                                                    <input type="hidden" name="version_ubl_37" id="version_ubl_37" value="2.0">
                                                                    <input type="hidden" name="version_estructura_38" id="version_estructura_38"
                                                                        value="1.0">
                                                                    <input type="hidden" name="tasa_igv" id="tasa_igv" value="0.18">
                                                                    <!--Fin de campos-->

                                                                    <input type="hidden" name="codigo_precio_14_1" id="codigo_precio"
                                                                        value="01">
                                                                    ...
                                                                    <div class="mb-3 col-lg-6">
                                                                        ...
                                                                        <input type="date" disabled="true" style="font-size: 12pt;"
                                                                            class="form-control" name="fecha_emision_01" id="fecha_emision_01"
                                                                    ...
                                                                    <div class="mb-3 col-lg-6">
                                                                        ...
                                                                        <select class="form-control" name="tipo_doc_ide" id="tipo_doc_ide"
                                                                            onchange="focusI()">
                                                    ...
                                                    <OPTION value="A">CED. D. IDE.</OPTION> -->
                                                                    ...
                                                                    <div class="mb-3 col-lg-12">
                                                                        ...
                                                                        <input type="text" class="form-control" name="numero_documento"
                                                                            id="numero_documento" placeholder="Número" value="-" required="true"
                                                                    ...
                                                                    <div class="mb-3 col-lg-12">
                                                                        ...
                                                                        <input type="text" class="form-control" name="razon_social"
                                                                            id="razon_social" maxlength="50" placeholder="NOMBRE COMERCIAL"
                                                                            width="50x" value="-" required="true" onkeyup="mayus(this);"
                                                                    ...
                                                                    <div class="mb-3 col-lg-12">
                                                                        ...
                                                                        <input type="text" class="form-control" name="domicilio_fiscal"
                                                                            id="domicilio_fiscal" value="-" onkeyup="mayus(this);"
                                                                            placeholder="Dirección" onkeypress="agregarArt(event)">
                                                                    </div>

                                                                    <div class="mb-3 col-lg-6">
                                                                        <label for="recipient-name" class="col-form-label">Vendedor:</label>
                                                                        <select autofocus name="vendedorsitio" id="vendedorsitio"
                                                                            class="form-control">
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div hidden class="mb-3 col-lg-6">
                                                                        ...
                                                                        <input type="text" name="guia_remision_25" id="guia_remision_25"
                                                                            class="form-control" placeholder="NRO DE GUÍA">
                                                                    </div>

                                                                    <div class="mb-3 col-lg-6">
                                                                        <label for="recipient-name" class="col-form-label">Impuesto:</label>
                                                                        <select class="form-control" name="codigo_tributo_18_3"
                                                                            id="codigo_tributo_18_3" onchange="tributocodnon()">TRIBUTO</select>
                                                                    </div>

                                                                    <div hidden class="mb-3 col-lg-6">
                                                                        <label for="recipient-name" class="col-form-label">Nro
                                                                            transferencia:</label>
                                                                        <input type="text" name="nroreferencia" id="nroreferencia"
                                                                            class="form-control" style="color: blue;"
                                                                            placeholder="N° Operación">
                                                                    </div>

                                                                    <div class="mt-2 mb-3 col-lg-12">
                                                                        <textarea name="descripcion_leyenda_26_2" id="descripcion_leyenda_26_2"
                                                                            cols="5" rows="3" class="form-control"
                                                                    ...
                                                                    <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12" hidden>
                                                                        <img src="../files/articulos/tarjetadc.png" data-toggle="tooltip"
                                                                            title="Pago por tarjeta"> <input type="checkbox" name="tarjetadc"
                                                                            id="tarjetadc" onclick="activartarjetadc();">
                                                                    ...
                                                                    <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12" hidden>
                                                                        <img src="../files/articulos/transferencia.png" data-toggle="tooltip"
                                                                            title="Pago por transferencia"> <input type="checkbox"
                                                                    ...
                                                                    <div class="modal fade text-left" id="modalcuotas" tabindex="-1"
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <button style="margin-left:0px;" type="button" data-bs-toggle="modal"
                                                                    data-bs-target="#myModalArt" id="btnAgregarArt"
                                                                    class="btn btn-danger btn-sm" onclick="cambiarlistadoum2()">
                                                                ...
                                                                <div class="mb-3 col-lg-12">
                                                                    ...
                                                                    <input type="text" name="codigob" id="codigob" class="form-control"
                                                                        ...
                                                                        placeholder="Digite o escanee el código de barras"
                                                                        onchange="quitasuge3()" style="background-color: #F5F589;">
                                                                    <div id="suggestions3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        onclick="botonrapido200()">200</button> -->
                                                            ...
                                                            monto perzonalizado</button> -->
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-content">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <p class="card-text">
                                                                                    <th id="CuadroT"
                                                                                        style="font-weight: bold; background-color:#FFB887;">
                                                                ...
                                                                <button style="margin-left:0px;" class="btn btn-primary btn-sm" type="submit"
                                                                    id="btnGuardar" data-toggle="tooltip" title="Guardar boleta"><i
                                                                        class="fa fa-save"></i>
                                                                    Guardar
                                                                </button>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><a onclick="cargarbien()" name="tipoitem" id="tipoitem"
                                                                value="bien"><img src="../public/images/producto.png"><br>Productos</a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="iigvresu" id="iigvresu" class="form-control" value="0"
                                                                readonly="">
                                                        </td>
                                                        <td>Impuesto ICBPER:</td>
                                                        <td><input type="text" name="iimpicbper" id="iimpicbper" class="form-control"
                                                                readonly=""></td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formularioncliente" id="formularioncliente" method="POST">
                                            ...
                                            <div class="form-group col-lg-2 col-md-12 col-sm-12 col-xs-12">
                                                <input type="number" class="" name="telefono1" id="telefono1" maxlength="15"
                                            ...
                                            <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                <input type="text" class="" name="email" id="email" maxlength="50" placeholder="CORREO"
                                    ...
                                    <form name="formularionarticulo" id="formularionarticulo" method="POST" style="margin: 2%;">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="stocknarticulo" id="stocknarticulo"
                                                    maxlength="100" required="true" onkeypress="return NumCheck(event, this)">
                                            </div>
                                            <div class="mb-3 col-lg-6">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="codigonarticulonarticulo"
                                                    id="codigonarticulonarticulo">
                                            </div>
                                            <div class="mb-3 col-lg-6">
                                            ...
                                            <div hidden class="mb-3 col-lg-6">
                                                <textarea class="form-control" id="descripcionnarticulo" name="descripcionnarticulo" rows="3"
                                                    cols="70" onkeyup="mayus(this)" onkeypress="return focusDescdet(event, this)"> </textarea>
                                            </div>
