                              ...
                              <div class="card">
                                <div class="card-body">
                                  <div class="row">
                                        ...
                                        <table id="detallesproducto" class="table table-striped"
                                          ...
                                          <tfoot style="vertical-align: center;">
                                            ...
                                            <tr>
                                              ...
                                              <td></td>
                                              <td></td>
                                              <th style="font-weight: bold;  background:#081A51;">Subtotal </th>
                                              <th style="font-weight: bold; background:#081A51;">
                                                <h4 style="color:white; font-size: 14px" id="subtotal">0.00</h4>
                                              </th>
                                              </td>
                                            </tr>
                                            <!--IGV-->
                                            <tr>
                                              ...
                                              <td></td>
                                              <td></td>
                                              <th style="font-weight: bold; vertical-align: center; background:#081A51;">igv 18%
                                              </th>
                                              <th style="font-weight: bold; background-color:#081A51; vertical-align: center;">
                                                <h4 style="color:white;font-size: 14px" id="igv_">0.00</h4>
                                              </th>
                                              </td>
                                            </tr>
                                            <!--TOTAL-->
                                            ...
                                            <td></td>
                                            <td></td>
                                            <th style="font-weight: bold; vertical-align: center; background:#081A51;">Total </th>
                                            <!--Datos de
                                       Impuestos--> <!--IGV-->
                                            <th style="font-weight: bold; background:#081A51;">
                                              <h4 id="total"
                                                style="font-weight: bold; vertical-align: center; background:#081A51; color:white;font-size: 14px">
                                                0.00</h4>
                                            </th>
                                      ...
                                      <table id="detallesservicio" class="table table-striped"
                                        ...
                                        <tfoot style="vertical-align: center;">
                                          ...
                                          <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <th style="font-weight: bold; vertical-align: center; background-color:#A5E393;">igv 18%
                                            </th>
                                          ...
                                          <td></td>
                                          <td></td>
                                          <th style="font-weight: bold; vertical-align: center; background-color:#A5E393;">Total
                                          </th>
                                          <!--Datos de
                                    impuestos--> <!--IGV-->
                                          <th style="font-weight: bold; background-color:#A5E393;">
                                            <h4 id="total_servicio"
                                              style="font-weight: bold; vertical-align: center; background-color:#A5E393;">0.00</h4>
                                    ...
                                    <div class="row">
                                      <button class="btn btn-primary col-lg-2" type="submit" id="btnGuardar" data-toggle="tooltip"
                                        title="Guardar factura"><i class="fa fa-save"></i> Guardar</button>
                                      <button id="btnCancelar" class="btn btn-danger col-lg-1" data-toggle="tooltip"
                                        title="Cancelar" onclick="cancelarform()" type="button"><i class="fa fa-arrow-circle-left">
                                          Cancelar</i></button>
                                    </div>
                                  </div>
                                </div>
