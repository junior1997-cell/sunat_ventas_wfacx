                            ...
                            <option value="EUR">EUROS</option> -->
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group col-lg-2 mt-4">
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#myModalArt">
                                          <button id="btnAgregarArt" type="button" class="btn btn-primary" style="top: 5px;"> <span
                                              class="fa fa-shopping-cart"></span> Agregar Artículos </button>
                                        </a>
                                      </div>
                                        ...
                                        <tfoot>
                                          ...
                                          <tr>
                                            ...
                                            <th id="CuadroT" style="font-weight: bold;">
                                              <h4 id="total" style="font-weight: bold; vertical-align: center; color:black;">0.00
                                              </h4>
                                          ...
                                          <tr>
                                            ...
                                            <td></td>
                                            <th id="Titulo"
                                              style="font-weight: bold; vertical-align: center; background-color:#081A51;">ADELANTO
                                              <label id="porade" style="font-weight: bold;">%</label>
                                            </th>
                                            <th style="font-weight: bold; background-color:#081A51;">
                                          ...
                                          <tr>
                                            ...
                                            <td></td>
                                            <th id="Titulo"
                                              style="font-weight: bold; vertical-align: center; background-color:#081A51;">FALTANTE
                                          ...
                                          <tr>
                                            ...
                                            <td></td>
                                            <th id="Titulo"
                                              style="font-weight: bold; vertical-align: center; background-color:#081A51;">TOTAL
                                              ABONAR
                                            </th> <!--Datos de impuestos--> <!--IGV-->
                                            <th id="CuadroT" style="font-weight: bold; background-color:#081A51;">
                                    ...
                                    <div class="row">
                                      <button class="btn btn-primary col-lg-2" type="submit" id="btnGuardar" data-toggle="tooltip"
                                        title="Guardar nota de venta"><i class="fa fa-save"></i> Guardar</button>
                                      <button id="btnCancelar" class="btn btn-danger col-lg-2" data-toggle="tooltip"
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="mb-3 col-lg-3" style="align-items: center;vertical-align: middle;position: relative;top: 28px;">
